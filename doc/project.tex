...
The model used is inspired by the VGG16 net. It consists of 6 blocks of two convolutional layers of the size 3x3 followed by a max pooling layer. The number of filters per convolutional layer is increasing with every block. Every convolutional layer uses batch normalization before the Relu activation function.
